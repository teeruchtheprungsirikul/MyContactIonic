(self["webpackChunkMyContactAPI"] = self["webpackChunkMyContactAPI"] || []).push([["common"],{
...
let ContactService = class ContactService {
    ...
    getUsers() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            let returnData = yield this.http.get("https://randomuser.me/api/?results=20").toPromise();
            console.log(returnData);
            this.contacts = returnData.results;
            return this.contacts;
        });
    }
    findUser(targetAccountId) {
