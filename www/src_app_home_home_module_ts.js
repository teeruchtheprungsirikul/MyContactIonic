(self["webpackChunkMyContactAPI"] = self["webpackChunkMyContactAPI"] || []).push([["src_app_home_home_module_ts"],{
...
let HomePage = class HomePage {
    constructor(navCtrl, contactService) {
    ...
    init() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            let resultArray = yield this.contactService.getUsers();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor=\"let item of contacts\" (click)=\"viewDetail(item)\">\n      <ion-avatar slot=\"start\">\n        <img src=\"{{ item.picture.large }}\">\n      </ion-avatar>\n      <div>\n        <h3>{{ item.name.first }} {{ item.name.last }}</h3>\n        <p>{{ item.cell }}</p>\n      </div>\n    </ion-item>\n  </ion-list>\n  \n</ion-content>\n");
